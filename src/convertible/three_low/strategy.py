...
移植自 cb_three_low.py:去掉 import jisilu_login / local_env,改接 common 层;
状态落 data/state/cb_three_low.json(common.storage 管理)。
"""
...
DEFAULT_CONFIG_PATH = _REPO_ROOT / "config" / "cb_three_low.yaml"
STATE_NAME = "cb_three_low"
